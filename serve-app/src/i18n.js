...
const AR = {
  ...
  'Add SERVE to your Home Screen': 'أضف SERVE إلى الشاشة الرئيسية',
  'iPhone only alerts installed apps. Tap Share, then “Add to Home Screen”, and open SERVE from there.': 'الآيفون يرسل التنبيهات للتطبيقات المثبتة فقط. اضغط مشاركة ثم «إضافة إلى الشاشة الرئيسية»، وافتح SERVE من هناك.',
  'Alerts are blocked': 'التنبيهات محظورة',
  'Enable notifications for this site in your browser settings.': 'فعّل الإشعارات لهذا الموقع من إعدادات المتصفح.',
  'Alerts on — while SERVE is open': 'التنبيهات مفعّلة — أثناء فتح SERVE',
  'This build can’t wake a closed app. You’ll still get alerts with SERVE open.': 'هذه النسخة لا تستطيع تنبيهك والتطبيق مغلق. ستصلك التنبيهات أثناء فتح SERVE.',
  'Alerts on': 'التنبيهات مفعّلة',
  'You’ll be alerted even when SERVE is closed.': 'ستصلك التنبيهات حتى لو كان SERVE مغلقًا.',
  'You’ll get a notification when your child asks you to pay.': 'سيصلك إشعار عندما يطلب طفلك الدفع.',
  'Alerts blocked in browser settings': 'التنبيهات محظورة في إعدادات المتصفح',
  ...
  'Block all': 'حظر الكل',
  'Clear': 'مسح',
  'Coach availability — tap the slots they DON’T work': 'أوقات المدرب — اضغط على الأوقات التي لا يعمل فيها',
  'Pick at least one day and one time': 'اختر يومًا واحدًا ووقتًا واحدًا على الأقل',
  'Use my location': 'استخدم موقعي',
  'Using your location': 'يتم استخدام موقعك',
  'Near you': 'بالقرب منك',
  'Locating…': 'جارٍ تحديد الموقع…',
  'Location off': 'الموقع مُعطّل',
  'Out of area': 'خارج النطاق',
  'out of area': 'خارج النطاق',
  ...
  'session': 'حصة',
  'sessions': 'حصص',
  'No players yet — add names below.': 'لا يوجد لاعبون بعد — أضف الأسماء بالأسفل.',

  // ── rates, opening hours & session length ──
  'Court rate': 'سعر الملعب',
  'hour': 'ساعة',
  'hr': 'ساعة',
  'Standard': 'عادي',
  'Peak': 'ذروة',
  'peak': 'ذروة',
  'at peak': 'في وقت الذروة',
  'at every hour': 'في كل ساعة',
  'same': 'نفسه',
  'Peak hours': 'ساعات الذروة',
  'Players see': 'يرى اللاعبون',
  'Opening hours': 'مواعيد العمل',
  'next day': 'اليوم التالي',
  'Closed at this hour': 'مغلق في هذه الساعة',
  'How long': 'المدة',
  'How long is each session?': 'ما مدة كل حصة؟',
  'Leave blank to use the branch rate': 'اتركه فارغًا لاستخدام سعر الفرع',
  'uses the branch rate': 'يستخدم سعر الفرع',
  'Total': 'الإجمالي',
  'Continue to pay': 'متابعة الدفع',
  'Available courts': 'الملاعب المتاحة',
  'Start time · today': 'وقت البدء · اليوم',
  'Court': 'ملعب',
  'courts': 'ملاعب',
  'All courts are busy': 'كل الملاعب مشغولة',
  'Every court is in use right now. Check the live tracker — one frees up soon.': 'كل الملاعب مستخدمة الآن. تابع الشاشة المباشرة — سيتحرر ملعب قريبًا.',
